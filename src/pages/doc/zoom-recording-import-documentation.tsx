  ...
  return (
    <div className="mb-56">
      ...
      <div className="mx-auto w-8/12 md:w-6/12">
        ...
        <p className="my-3"><u>Prerequisites</u></p>
        ...
        <p className="my-3"><u>Installation steps</u></p>
        ...
        <p className="my-3"><u>Scopes</u></p>
        <p>By installing the application, you will be asked to grant the following permission scopes: </p>
        <ul className="list-disc ml-5">
          <li>account:read:admin (In order to retrieve all the recordings of your Master Account)</li>
          <li>recording:read:admin (In order to be able to download the recordings video files)</li>
        </ul>
        ...
        <p>To remove the &quot;api.video import tool&quot; application, you can follow one of these two methods:</p>

        <p className="my-3"><u>1st method (prefered): revoking the access token from the application</u></p>
        <p>Go to  <a  className="text-blue-500 underline" href="https://import.api.video/zoom">https://import.api.video/zoom</a>.</p>
        <p>If you&apos;re currently logged in, you will see a &quot;Revoke Zoom access&quot; link right under the &quot;Successfully signed into Zoom&quot; button. Click on it and the access token used by the application to access your Zoom data will be revoked.</p>
        
        <p className="my-3"><u>2nd method: disconect the application from the Zoom Marketplace</u></p>
        <ul className="list-disc ml-5">
        ...
        <p className="my-3"><u>Deleting the imported recordings from api.video</u></p>
        ...
        <p>Go to the &quot;Videos&quot; section and select the video you want to delete. Click on the &quot;Delete&quot; button.</p>
