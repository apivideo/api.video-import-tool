        ...
        <div className="container help-page">
            <main className="main">
                ...
                <div className="content">
                    ...
                    <Image width="1030px" height="140px" alt="Create a Vimeo application" src="/vimeo-create-app.png" />
                    ...
                    <Image width="972px" height="470px" alt="Create a Vimeo application" src="/vimeo-app-creation-form.png" />
                    ...
                    <Image width="737px" height="513px" alt="Create a Vimeo application" src="/vimeo-create-access-token.png" />
                    ...
                    <Image width="803px" height="210px" alt="Create a Vimeo application" src="/vimeo-copy-access-token.png" />
                </div>
            </main>
        </div>
    )
